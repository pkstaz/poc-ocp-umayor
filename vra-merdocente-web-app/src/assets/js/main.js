...
(function() {
  "use strict";
	console.log('%c[DEBUG] cargando archivo main.js >>>>>>>>>>', 'background: #28a745; color: #FFFFFF; padding: 2px 5px;');
  /**
...
/* 	let inputSelect = document.querySelectorAll('.select2');
	inputSelect.select2(); */
